...
export default function Quiz90s() {
  ...
  const shareWhatsApp = () => {
    const text = result ? "Je suis " + result.personnage_principal + " ! Decouvre ton profil 90s : https://quizz90s.vercel.app" : "Decouvre ton profil 90s : https://quizz90s.vercel.app";
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: "620px", margin: "0 auto", padding: "24px 16px", minHeight: "100vh", display: "flex", flexDirection: "column", justifyContent: "center" }}>
        ...
        {step === "intro" && (
          <div style={{ animation: "fadeIn 0.5s ease" }}>
            <div style={{ textAlign: "center", marginBottom: "36px" }}>
              <div style={{ fontSize: "11px", letterSpacing: "4px", color: C.a1, textTransform: "uppercase", marginBottom: "14px" }}>QUIZ PERSONNALITE</div>
            ...
            <div style={{ background: C.card, border: "1px solid " + C.border, borderRadius: "12px", padding: "22px", marginBottom: "28px" }}>
              <p style={{ fontSize: "15px", lineHeight: 1.7, color: "#ccc", margin: 0 }}>
                ...
                <br /><br />
                Avec l'IA, pour la premiere fois, le resultat te ressemble <span style={{ color: "#fff" }}>vraiment</span>. 12 questions. Un profil unique. Zero case prefabriquee.
              </p>
            </div>
        ...
        {step === "quiz" && (
          <div style={{ animation: "fadeIn 0.3s ease" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              ...
              {!showCustom ? (
                <button onClick={() => { setShowCustom(true); setTimeout(() => inputRef.current && inputRef.current.focus(), 50); }}
                ...
                <div style={{ display: "flex", gap: "8px" }}>
                  ...
                  <button onClick={() => customInput.trim() && handleAnswer(customInput.trim())}
                    style={{ padding: "14px 20px", fontSize: "16px", cursor: "pointer", background: C.a3, border: "none", borderRadius: "10px", color: "white", fontWeight: "700" }}>
                    &rarr;
                  </button>
                </div>
              )}
        ...
        {step === "loading" && (
          <div style={{ textAlign: "center", animation: "fadeIn 0.4s ease" }}>
            ...
            <p style={{ color: C.muted, fontSize: "14px", lineHeight: 1.6 }}>L'IA rewind les 90s,<br />croise tes reponses avec 90 personnages,<br />et te genere un profil unique.</p>
          ...
          <div style={{ animation: "fadeIn 0.5s ease" }}>
              ...
              <div style={{ fontFamily: "Georgia, 'Times New Roman', serif", fontSize: "clamp(24px,5vw,34px)", fontWeight: "700", lineHeight: 1.1, color: "#fff", marginBottom: "8px", letterSpacing: "-0.5px" }}>
                {result.personnage_principal.includes(" x ") ? (
                  <>
                    ...
                    <span style={{ color: "#FF6B9D", fontStyle: "italic" }}> x </span>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              <button onClick={copyImage} style={{
                ...
                {copyState === "copying" && "Generation..."}
                {copyState === "done" && "Image copiee !"}
              </button>
